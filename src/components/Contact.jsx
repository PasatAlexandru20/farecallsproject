...
const Contact = () => {
  return (
    <section>
    <div class="container my-24 px-6 mx-auto bg-pal-white rounded-lg rounded-md  ">
      {/* <!-- Section: Design Block --> */}
      <section class="mb-32 text-gray-800">
        <div class="flex justify-center">
          <div class="text-center lg:max-w-3xl md:max-w-xl">
            <h2 class="text-3xl font-bold mb-12 px-6 mt-16">Contact us</h2>
          </div>
        </div>
    
        <div class="flex flex-wrap py-16 px-16">
